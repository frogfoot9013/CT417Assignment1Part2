 ...
 */
package CT417Assignment1Part2;
import CT417Assignment1.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // create Students
        Student st1 = new Student("Joe Smith", 2000, 12, 1, 20913);
        Student st2 = new Student("Jane Jones", 1999, 11, 29, 19031);
        Student st3 = new Student("Saoirse Mullen", 2001, 3, 12, 21325);
        Student st4 = new Student("Mary Walshe", 2002, 7, 13, 22597);
